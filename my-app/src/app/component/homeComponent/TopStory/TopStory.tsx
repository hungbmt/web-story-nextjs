...
import SwiperTrue from "@/app/ComponentStories/ui/Swiper/SwiperTrue/SwiperTrue";

interface typeGimStory {
  dataTop: any;
}
const TopStory: React.FC<typeGimStory> = ({ dataTop }) => {
              ...
              {currentSlideText === "Top ngày" && (
                <>
                  <div className="product-top-day-box">
                    ...
                    >
                      {dataTop?.viewDay.map(
                        (dataTopDay: typeGethome, inx: number) => (
                          <SwiperSlide
                            virtualIndex={inx}
                            key={`${dataTopDay.id} - ${inx}`}
                          >
                            <Link
                              href={`${"/book/" + dataTopDay.slug + "?page=1"}`}
                            >
                ...
                <>
                  <div className="product-top-today-box">
                    <Swiper
                      ...
                      className="mySwiper"
                    >
                      {dataTop.viewToday?.map(
                        (dataTopToDay: typeGethome, inx: number) => (
                          <SwiperSlide
                ...
                <>
                  <div className="product-top-month-box">
                    <Swiper
                      ...
                      className="mySwiper"
                    >
                      {dataTop.viewmoth?.map(
                        (dataTopMoth: typeGethome, inx: number) => (
                          <SwiperSlide
                ...
                <>
                  <div className="product-top-year-box">
                    <Swiper
                      ...
                      className="mySwiper"
                    >
                      {dataTop?.viewyear?.map(
                        (dataTopYear: typeGethome, inx: number) => (
                          <SwiperSlide
